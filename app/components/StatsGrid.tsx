...
export default function StatsGrid() {
  ...
  useGSAP(
    () => {
      ...
      if (statCards) {
        gsap.fromTo(
          ...
          { opacity: 0, y: "1.25em" },
          {
            ...
            ease: "power3.out",
            scrollTrigger: {
              trigger: containerRef.current?.querySelector(".stats-grid-wrapper"),
              start: "top 80%",
              once: true,
            },
          }
      ...
      const imageContainer = containerRef.current?.querySelector(".stats-image-container");
      if (imageContainer) {
        gsap.fromTo(
          imageContainer,
      ...
      // Holographic Badge reveal animation
      const badge = containerRef.current?.querySelector(".stats-badge");
      if (badge) {
        gsap.fromTo(
          badge,
          { opacity: 0, y: 30 },
  ...
  return (
    <section ref={containerRef} id="s-numbers" className="relative z-10 bg-[#F4EDE6] overflow-hidden">
      {/* Background video */}
      ...
      <div className="relative z-10 w-full py-[4em] lg:py-[var(--section-padding)] px-[var(--padding-web)]">
        {/* Header */}
        <div className="mb-[3.5em] lg:mb-[5em]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[3em] lg:gap-[5em] items-start">
          {/* Left: Large Image with Holographic Telemetry Badge */}
          <div className="stats-image-container opacity-0 relative aspect-[4/5] lg:aspect-[1/1.2] overflow-hidden rounded-[16px] border border-[#2e3a1f]/10 shadow-[0_15px_40px_rgba(46,58,31,0.06)] group/image">
             <img 
             ...
             <div className="stats-badge opacity-0 absolute bottom-[1.5em] left-[1.5em] right-[1.5em] sm:right-auto bg-[#0D1508]/85 backdrop-blur-md border border-[#F4EDE6]/10 px-[1.5em] py-[1.2em] rounded-[16px] text-left shadow-[0_20px_50px_rgba(0,0,0,0.3)] z-10 transition-all duration-300 hover:border-[#22C55E]/30">
          ...
          <div className="stats-grid-wrapper grid grid-cols-2 gap-x-[1.5em] lg:gap-x-[4em] gap-y-[2.5em] lg:gap-y-[6em]">
            {stats.map((stat, i) => (
              <div 
                key={i} 
              ...
              >
                ...
                <div className="pt-[1.5em] transition-transform duration-300 group-hover/card:translate-x-1">
                  ...
                  <p className="text-16-regular-caps text-[#2e3a1f] max-w-[12em] transition-colors duration-300 group-hover/card:text-[#2e3a1f]/90">
                    {stat.label}
                  </p>
                </div>
              </div>
            ...
            <p className="col-span-2 text-[0.6rem] md:text-[0.7rem] text-[#2e3a1f]/65 max-w-[45em] mt-[1.5em] lg:mt-[2em] tracking-wide uppercase leading-normal">
